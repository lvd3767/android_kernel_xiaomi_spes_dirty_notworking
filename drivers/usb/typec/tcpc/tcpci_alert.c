...
static inline void tcpci_vbus_level_init_v10(struct tcpc_device *tcpc, u16 power_status)
{
...
#ifdef CONFIG_USB_POWER_DELIVERY
static inline bool tcpci_check_hard_reset_complete(struct tcpc_device *tcpc, u32 alert_status)
{
