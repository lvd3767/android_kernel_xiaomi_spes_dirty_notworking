...
static inline int typec_enable_low_power_mode(struct tcpc_device *tcpc, u8 pull);
...
static inline int typec_set_plug_orient(struct tcpc_device *tcpc, u8 res, bool polarity)
{
...
static inline u8 typec_get_sink_dbg_acc_rp_level(int cc1, int cc2)
{
...
static inline bool typec_is_ignore_cc_change(struct tcpc_device *tcpc, u8 rp_present)
{
...
int tcpc_typec_set_rp_level(struct tcpc_device *tcpc, u8 res)
{
	switch (res) {
