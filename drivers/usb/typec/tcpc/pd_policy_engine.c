...
static inline void print_state(struct pd_port *pd_port, u8 state)
{
	/*
...
static inline u8 pd_try_get_deferred_tcp_event(struct pd_port *pd_port)
{
...
static inline u8 pd_try_get_active_event(struct tcpc_device *tcpc,
...
static inline u8 pd_try_get_next_event(struct tcpc_device *tcpc,
				       struct pd_event *pd_event)
{
	u8 ret = 0;
	struct pd_port *pd_port = &tcpc->pd_port;
