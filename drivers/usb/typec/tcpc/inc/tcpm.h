...
int tcpm_typec_change_role_postpone(struct tcpc_device *tcpc, u8 typec_role, bool postpone);
...
int tcpm_inquire_pd_partner_modes(struct tcpc_device *tcpc, u16 svid,
...
int tcpm_update_pd_status_temp(struct tcpc_device *tcpc,
			       enum pd_present_temperature_flag ptf, u8 temperature);

int tcpm_update_pd_status_input(struct tcpc_device *tcpc, u8 input, u8 mask);

int tcpm_update_pd_status_bat_input(struct tcpc_device *tcpc, u8 bat_input, u8 bat_mask);
...
static inline u8 tcpm_inquire_cable_current(struct tcpc_device *tcpc)
{
...
static inline bool tcpm_extract_power_cap_val(u32 pdo, struct tcpm_power_cap_val *cap)
{
	return false;
}
