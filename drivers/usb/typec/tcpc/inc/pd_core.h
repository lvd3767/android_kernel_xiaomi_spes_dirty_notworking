...
void pd_noitfy_pe_bist_mode(struct pd_port *pd_port, u8 mode);
...
int pd_send_data_msg(struct pd_port *pd_port, u8 sop_type,
		     u8 msg, u8 cnt, u32 *payload);
...
int pd_send_svdm_request(struct pd_port *pd_port, u8 sop_type,
			 u16 svid, u8 vdm_cmd,
			 u8 obj_pos, u8 cnt,
			 u32 *data_obj, u32 timer_id);
