...
static inline u8 pe30_power_ready_entry(struct pd_port *pd_port)
{
	u8 rx_cap = PD_RX_CAP_PE_READY_UFP;
...
static inline u8 pe20_power_ready_entry(struct pd_port *pd_port)
{
	u8 rx_cap = PD_RX_CAP_PE_READY_UFP;
