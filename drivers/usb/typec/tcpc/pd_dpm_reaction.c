...
const u32 c_get_status_alert_type = ADO_ALERT_OCP |
	ADO_ALERT_OTP | ADO_ALERT_OVP |
	ADO_ALERT_OPER_CHANGED | ADO_ALERT_SRC_IN_CHANGED;

static inline u8 dpm_reaction_alert_status_changed(struct pd_port *pd_port)
{
...
static inline u8 dpm_reaction_alert_battry_changed(struct pd_port *pd_port)
{
	u8 i;
	u8 mask;
	u8 bat_change_i = 255;
...
static inline u8 dpm_get_pd_connect_state(struct pd_port *pd_port)
{
...
static inline u8 dpm_get_reaction_env(struct pd_port *pd_port)
{
	u8 conditions;
...
static inline u8 dpm_check_reaction_available(struct pd_port *pd_port,
